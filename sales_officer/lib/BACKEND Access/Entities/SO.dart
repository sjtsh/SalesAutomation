...
class SO {
  ...
  factory SO.fromJson(Map<String, dynamic> json) {
    return SO(
      ...
      json['7'] == null ? "null": json['7'].round(),
      json['8'] == null ? "null": json['8'].round(),
      json['9'] == null ? "null": json['9'].round(),
      json['10'] == null ? "null": json['10'].round(),
      json['11'] == null ? "null": json['11'].round(),
      json['12'] == null ? "null": json['12'].round(),
      json['13'] == 0 ? false : true,
      json['14'] == null ? "null": json['14'].round(),
      json['15'] == 0 ? false : true,
      json['16'] == null ? "null": json['16'].round(),
      json['17'] == null ? "null": json['17'].round(),
      json['18'] == null ? "null": json['18'].round(),
    );
  }
}
