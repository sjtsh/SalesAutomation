...
class BezierData extends StatefulWidget {
  ...
  BezierData(this.changeExpanded, this.isMTD, this.toggleValue, this.refresh);
      ...
      children: [
        Builder(builder: (context) {
          if (widget.isMTD) {
            ...
            if (listOfProducts
              ...
              return Column(
                children: listOfProducts
                    ...
                    .asMap()
                    .entries
                    .map((item) => ExpandableHeader(item, widget.isMTD))
                    .toList(),
              );
            } else {
              return Column(
            ...
            listOfProducts.sort((a, b) => b[1][1].compareTo(a[1][1]));
            if (listOfProducts
        ...
        InkWell(
          onTap: () {
            Navigator.push(context, MaterialPageRoute(builder: (_) {
              return SeeAllSalesScreen(widget.isMTD, widget.refresh,
                  widget.toggleValue, listOfProducts);
            }));
          },
          child: Padding(
